...
const ABI = require("../artifacts/contracts/Heroine.sol/Heroine.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Heroine");
  const nft = await NFT.attach("0x4f5304575DE8352e44A0d7ac320081191b044E2E");
